...
const AdminDealersListPage = () => {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Dealers Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Dealers</h4>
          <AddButton link={ "/admin/add-dealers" } />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/admin/edit-dealers/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/admin/view-dealers/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default AdminDealersListPage;
