...
const columns = [
  ...
  },
  {
    ...
    isSortedDesc: false,
    mappingExist: true,
    mappings: { 0: 'Floating Dock', 1: 'Sectional Dock', 2: 'Roll-In Dock' }
  },
  {
    header: 'Materials',
    accessor: 'materials',
    ...
    isSortedDesc: false,
    mappingExist: true,
    mappings: { 0: 'Wood Grain', 1: 'Perforated', 2: 'Grey Aluminium' }
  },
  {
    header: 'Length',
    accessor: 'length',
...
const AdminDocksListPage = () => {
  ...
  const onSubmit = ( data ) => {
    let category = getNonNullValue( data.category );
    let materials = getNonNullValue( data.materials );
    let length = getNonNullValue( data.length );
    let width = getNonNullValue( data.width );
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Docks Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Docks</h4>
          <AddButton link={ "/admin/add-docks" } />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/admin/edit-docks/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/admin/view-docks/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default AdminDocksListPage;
