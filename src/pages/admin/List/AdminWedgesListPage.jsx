...
const columns = [
  ...
  },
  {
    ...
    isSortedDesc: false,
    mappingExist: true,
    mappings: { 0: 'Floating Wedge', 1: 'Roll-In Wedge' }
  },
  {
    header: 'Length',
    accessor: 'length',
...
const AdminWedgesListPage = () => {
  ...
  const onSubmit = ( data ) => {
    ...
    let material = getNonNullValue( data.material );
    let filter = {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Wedges Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Wedges</h4>
          <AddButton link={ "/admin/add-wedges" } />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={ () => {
                                navigate( "/admin/edit-wedges/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
                            ...
                            <button
                              ...
                              onClick={ () => {
                                navigate( "/admin/view-wedges/" + row.id, {
                                  state: row,
                                } );
                              } }
                            >
...
export default AdminWedgesListPage;
