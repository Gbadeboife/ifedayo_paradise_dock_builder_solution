...
const AdminReferenceItemsListPage = () => {
  ...
  const onSubmit = (data) => {
    ...
    let image = getNonNullValue(data.image);
    let filter = {
      id,
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">ReferenceItems Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">ReferenceItems</h4>
          <div className="flex">
            <AddButton link={"/admin/add-reference_items"} />
                        ...
                        return (
                          ...
                          >
                            <button
                              ...
                              onClick={() => {
                                navigate(
                                  "/admin/edit-reference_items/" + row.id,
                                  {
                                    state: row,
                                  }
                                );
                            ...
                            <button
                              ...
                              onClick={() => {
                                navigate(
                                  "/admin/view-reference_items/" + row.id,
                                  {
                                    state: row,
                                  }
                                );
...
export default AdminReferenceItemsListPage;
