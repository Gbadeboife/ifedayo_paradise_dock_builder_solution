...
// import PaginationBar from "Components/ExportButton";
...
const AdminAccessoriesListPage = () => {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Accessories Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Accessories</h4>
          <AddButton link={"/admin/add-accessories"} />
        </div>
                    ...
                    {columns.map((cell, index) => {
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/admin/edit-accessories/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
                            ...
                            <button
                              ...
                              onClick={() => {
                                navigate("/admin/view-accessories/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
                      ...
                      return (
                        <td key={index} className="px-6 py-4 whitespace-nowrap">
                          {["thumbnail", "top_view"].includes(cell.accessor) ? (
                            <img
                              className={`w-[50px] h-[20px] rounded`}
...
export default AdminAccessoriesListPage;
