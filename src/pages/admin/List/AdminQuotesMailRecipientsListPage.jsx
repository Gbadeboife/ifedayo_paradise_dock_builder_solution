...
const AdminQuotesMailRecipientsListPage = () => {
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Quotes Mail Recipients Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Quotes Mail Recipients</h4>
          <div className="flex">
            <AddButton link={"/admin/add-quotes_mail_recipients"} />
                        ...
                        return (
                          ...
                          >
                            <button
                              ...
                              onClick={() => {
                                navigate(
                                  "/admin/edit-quotes_mail_recipients/" +
                                    row.id,
                                  {
                                    state: row,
                                  }
                            ...
                            <button
                              ...
                              onClick={() => {
                                navigate(
                                  "/admin/view-quotes_mail_recipients/" +
                                    row.id,
                                  {
                                    state: row,
                                  }
...
export default AdminQuotesMailRecipientsListPage;
