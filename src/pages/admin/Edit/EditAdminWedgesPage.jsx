...
const EditAdminWedgesPage = () => {
  ...
  const [ category, setCategory ] = useState( 0 ); const [ length, setLength ] = useState( 0 ); const [ width, setWidth ] = useState( 0 ); const [ image, setImage ] = useState( '' ); const [ top_view, setTopView ] = useState( '' ); const [ material, setMaterial ] = useState( 0 );
  ...
  return (
    <div className=" shadow-md rounded   mx-auto p-5">
      <h4 className="text-2xl font-medium">Edit Wedges</h4>
...
export default EditAdminWedgesPage;
